...
help() {
    ...
    echo -e " ==================================================== "
    echo " "
    echo -e "${GC} Usage:${eC} $0 [OPTION]...[COMPILER OPTIONS]...[DG4EST OPTIONS]...[3PL OPTIONS]"
    echo " "
    ...
    echo "  [OPTION]:"
    echo "    --3pl       -3pl       build the 3rd party libraries: metis, p4est"
    echo "    --demo      -demo      build demo amr solver"
    echo " "
...
# =================================================================== #
if [ $BUILD_DEMO == 0 -a $BUILD_3PL == 0 ]; then
  echo "=================================================================="
  echo "Building the Metis, P4est, and Demo..."
  echo "=================================================================="
  echo " "
  ...
  echo -e " Executable: ${GC}builds/demo_release/bin/demo.mpi${eC}"
  echo "================================================"
  exit 0
fi
