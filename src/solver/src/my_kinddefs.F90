...
!     
! \file   my_kinddefs.F90
! \author akirby
!
! Created on August 27, 2018, 11:51 AM
!
...
!      are mad accessible through variables sp and dp 
...
module my_kinddefs
    ...
    public sp, dp, cp, i1, i2, i4, i8, i16
    public PI, TWOPI, PIO2, half,one,two,onethird,onefourth,twothird,fourthird,onesixth,oneeighth,threeeighth
    public oneO_1024_1024,oneO_1024_1024_1024,oneO_1000_1000_1000
    ...
    real(dp), parameter :: onefourth = 0.25_dp
    real(dp), parameter :: twothird= 2._dp/3._dp
    real(dp), parameter :: fourthird= 4._dp/3._dp
    real(dp), parameter :: oneeighth= 1.0_dp/8.0_dp
    real(dp), parameter :: threeeighth= 3.0_dp/8.0_dp
    real(dp), parameter :: oneO_1024_1024 = 1.0_dp/(1024.0_dp*1024.0_dp)
    real(dp), parameter :: oneO_1024_1024_1024 = 1.0_dp/(1024.0_dp*1024.0_dp*1024.0_dp)
    real(dp), parameter :: oneO_1000_1000_1000 = 1.0_dp/(1000.0_dp*1000.0_dp*1000.0_dp)
