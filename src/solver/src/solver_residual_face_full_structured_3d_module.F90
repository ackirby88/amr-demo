...
!>     
!> \file   solver_residual_face_full_structured_3d_module.F90
!> \author akirby
!> \ingroup solver_group
!> \brief 3D full face residual structured grid
!>
!> Created on August 30, 2018, 9:21 AM
!>

module solver_residual_face_full_structured_3d_module
    implicit none
    contains
    
    
    !> 3D full face residual structured grid
    !>
    ...
    !>
    subroutine solver_residual_face_full_structured_3d(nfields,nelem_subgrid,side,level,&
        ...
        select case(side)
            ...
            case(1) !xhi
                ...
                do j = 1,nelem_subgrid
                    ...
                    call flux_roe_3d(ql(:,nelem_subgrid,j,k),qr(:,1,j,k),normal_vec,flux)
            ...
            case(3) !yhi
                ...
                do i = 1,nelem_subgrid
                    ...
                    call flux_roe_3d(ql(:,i,nelem_subgrid,k),qr(:,i,1,k),normal_vec,flux)
            ...
            case(5) !zhi
                ...
                do i = 1,nelem_subgrid
                    ...
                    call flux_roe_3d(ql(:,i,j,nelem_subgrid),qr(:,i,j,1),normal_vec,flux)
